...
//		new Thread(new TaskThread(threadB)).start();
	...
	public void run() {
		...
		try {
			EmitLog.main(new String[]{argv[0]});
			EmitLog.main(new String[]{argv[1]});
			EmitLog.main(new String[]{argv[2]});
			EmitLog.main(new String[]{argv[3]});
			EmitLog.main(new String[]{argv[4]});
			EmitLog.main(new String[]{argv[5]});
			EmitLog.main(new String[]{argv[6]});
			EmitLog.main(new String[]{argv[7]});
			EmitLog.main(new String[]{argv[8]});
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
